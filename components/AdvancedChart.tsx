...
export default function AdvancedChart({ measurements, period }: AdvancedChartProps) {
  ...
  const getTimeZoneData = () => {
    const zones = {
      morning: { label: 'Matin (6h-12h)', data: [] as number[], color: '#FF9A9E' },
      afternoon: { label: 'Après-midi (12h-18h)', data: [] as number[], color: '#FECFEF' },
      evening: { label: 'Soir (18h-22h)', data: [] as number[], color: '#A8EDEA' },
      night: { label: 'Nuit (22h-6h)', data: [] as number[], color: '#FED6E3' }
    };
